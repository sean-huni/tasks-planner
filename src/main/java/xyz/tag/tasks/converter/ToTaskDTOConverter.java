 ...
 */
@Component
public class ToTaskDTOConverter implements Converter<TaskDO, TaskDTO> {
    /**
    ...
    public TaskDTO convert(TaskDO source) {
        return new TaskDTO(source.getId(), source.getName(), source.getDueDate(), source.getCompleted());
    }
}
